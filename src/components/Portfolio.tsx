...
const services = [
  ...
  },
  {
    ...
    description: "Whalys est une application d'organisation pour les agences de design. Centralisez, annotez visuellement et transformez chaque erreur en une règle pour Wiki.",
